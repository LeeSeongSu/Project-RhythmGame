...
public class NoteEffectKeyListener implements EventHandler<KeyEvent>{
	...
	public void handle(KeyEvent event) {
		...
		case S:removeEffect(0); break;
		case D:removeEffect(1); break;
		case F:removeEffect(2); break;
		case J:removeEffect(4); break;
		case K:removeEffect(5); break;
		case L:removeEffect(6); break;
		}
	}
